...
type CreateWorkflowRequest struct {
	...
	IdempotencyKey                   string                 `protobuf:"bytes,8,opt,name=idempotency_key,json=idempotencyKey,proto3" json:"idempotency_key,omitempty"`                                                              // Idempotency key for retry-safe creation
...
type UpdateWorkflowRequest struct {
	...
	Interval                         int32                  `protobuf:"varint,5,opt,name=interval,proto3" json:"interval,omitempty"`                                                                                               // Interval measured in minutes
	MaxConsecutiveJobFailuresAllowed int32                  `protobuf:"varint,6,opt,name=max_consecutive_job_failures_allowed,json=maxConsecutiveJobFailuresAllowed,proto3" json:"max_consecutive_job_failures_allowed,omitempty"` // Maximum number of consecutive job failures allowed
	IdempotencyKey                   string                 `protobuf:"bytes,7,opt,name=idempotency_key,json=idempotencyKey,proto3" json:"idempotency_key,omitempty"`                                                              // Idempotency key for retry-safe update
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *UpdateWorkflowRequest) GetIdempotencyKey() string {
	if x != nil {
		return x.IdempotencyKey
	}
	return ""
...
func (x *GetWorkflowResponse) GetLogRetention() bool {
	if x != nil {
		return x.LogRetention
	}
	return false
...
func (x *GetWorkflowByIDResponse) GetLogRetention() bool {
	if x != nil {
		return x.LogRetention
	}
	return false
...
type IncrementWorkflowConsecutiveJobFailuresCountRequest struct {
	...
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                       // ID of the workflow
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // ID of the user
	JobId         string                 `protobuf:"bytes,3,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`    // ID of the failed job
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IncrementWorkflowConsecutiveJobFailuresCountRequest) GetJobId() string {
	if x != nil {
		return x.JobId
	}
	return ""
...
func (x *WorkflowsByUserIDResponse) GetLogRetention() bool {
	if x != nil {
		return x.LogRetention
	}
	return false
...
const file_workflows_workflows_proto_rawDesc = "" +
	"\n" +
	"\x19workflows/workflows.proto\x12\tworkflows\"\xc3\x02\n" +
	...
	"\rlog_retention\x18\a \x01(\bH\x00R\flogRetention\x88\x01\x01\x12'\n" +
	"\x0fidempotency_key\x18\b \x01(\tR\x0eidempotencyKeyB\x10\n" +
	"\x0e_log_retention\"(\n" +
	...
	"\rListWorkflows\x12\x1f.workflows.ListWorkflowsRequest\x1a .workflows.ListWorkflowsResponse\"\x00BFZDgithub.com/hitesh22rana/chronoverse/pkg/proto/go/workflows;workflowsb\x06proto3"
