...
func (m *MockRepository) Login(ctx context.Context, email, password string) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Register(ctx context.Context, email, password string) (string, error) {
	m.ctrl.T.Helper()
