...
type CreateNotificationRequest struct {
	...
	IdempotencyKey string                 `protobuf:"bytes,4,opt,name=idempotency_key,json=idempotencyKey,proto3" json:"idempotency_key,omitempty"` // Idempotency key for retry-safe notification creation
...
const file_notifications_notifications_proto_rawDesc = "" +
	"\n" +
	"!notifications/notifications.proto\x12\rnotifications\"\x8b\x01\n" +
	...
	"\x11ListNotifications\x12'.notifications.ListNotificationsRequest\x1a(.notifications.ListNotificationsResponse\"\x00BNZLgithub.com/hitesh22rana/chronoverse/pkg/proto/go/notifications;notificationsb\x06proto3"
