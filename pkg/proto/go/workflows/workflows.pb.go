...
type TestWorkflowRunStatus int32

const (
	TestWorkflowRunStatus_TEST_WORKFLOW_RUN_STATUS_UNSPECIFIED TestWorkflowRunStatus = 0 // Unspecified status
	TestWorkflowRunStatus_TEST_WORKFLOW_RUN_STATUS_BUILDING    TestWorkflowRunStatus = 1 // Workflow run is building
	TestWorkflowRunStatus_TEST_WORKFLOW_RUN_STATUS_RUNNING     TestWorkflowRunStatus = 2 // Workflow run is in progress
	TestWorkflowRunStatus_TEST_WORKFLOW_RUN_STATUS_COMPLETED   TestWorkflowRunStatus = 3 // Workflow run has completed successfully
	TestWorkflowRunStatus_TEST_WORKFLOW_RUN_STATUS_FAILED      TestWorkflowRunStatus = 4 // Workflow run has failed
	TestWorkflowRunStatus_TEST_WORKFLOW_RUN_STATUS_CANCELED    TestWorkflowRunStatus = 5 // Workflow run was canceled
)

// Enum value maps for TestWorkflowRunStatus.
var (
	TestWorkflowRunStatus_name = map[int32]string{
		0: "TEST_WORKFLOW_RUN_STATUS_UNSPECIFIED",
		1: "TEST_WORKFLOW_RUN_STATUS_BUILDING",
		2: "TEST_WORKFLOW_RUN_STATUS_RUNNING",
		3: "TEST_WORKFLOW_RUN_STATUS_COMPLETED",
		4: "TEST_WORKFLOW_RUN_STATUS_FAILED",
		5: "TEST_WORKFLOW_RUN_STATUS_CANCELED",
	}
	TestWorkflowRunStatus_value = map[string]int32{
...
func (x TestWorkflowRunStatus) Enum() *TestWorkflowRunStatus {
	p := new(TestWorkflowRunStatus)
	*p = x
	return p
}

func (x TestWorkflowRunStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TestWorkflowRunStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_workflows_workflows_proto_enumTypes[0].Descriptor()
}

func (TestWorkflowRunStatus) Type() protoreflect.EnumType {
	return &file_workflows_workflows_proto_enumTypes[0]
}

func (x TestWorkflowRunStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TestWorkflowRunStatus.Descriptor instead.
func (TestWorkflowRunStatus) EnumDescriptor() ([]byte, []int) {
...
// StreamTestWorkflowRunResponse contains the streamed response for a test workflow run.
type StreamTestWorkflowRunResponse struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	Status TestWorkflowRunStatus  `protobuf:"varint,1,opt,name=status,proto3,enum=workflows.TestWorkflowRunStatus" json:"status,omitempty"` // Current status of the test workflow run
	// Types that are valid to be assigned to Data:
	//
	//	*StreamTestWorkflowRunResponse_Log
	//	*StreamTestWorkflowRunResponse_Message
	Data          isStreamTestWorkflowRunResponse_Data `protobuf_oneof:"data"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StreamTestWorkflowRunResponse) Reset() {
	*x = StreamTestWorkflowRunResponse{}
	mi := &file_workflows_workflows_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StreamTestWorkflowRunResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamTestWorkflowRunResponse) ProtoMessage() {}

func (x *StreamTestWorkflowRunResponse) ProtoReflect() protoreflect.Message {
	mi := &file_workflows_workflows_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamTestWorkflowRunResponse.ProtoReflect.Descriptor instead.
func (*StreamTestWorkflowRunResponse) Descriptor() ([]byte, []int) {
	return file_workflows_workflows_proto_rawDescGZIP(), []int{22}
}

func (x *StreamTestWorkflowRunResponse) GetStatus() TestWorkflowRunStatus {
	if x != nil {
		return x.Status
	}
	return TestWorkflowRunStatus_TEST_WORKFLOW_RUN_STATUS_UNSPECIFIED
}

func (x *StreamTestWorkflowRunResponse) GetData() isStreamTestWorkflowRunResponse_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *StreamTestWorkflowRunResponse) GetLog() *jobs.Log {
	if x != nil {
		if x, ok := x.Data.(*StreamTestWorkflowRunResponse_Log); ok {
			return x.Log
		}
	}
	return nil
...
func (x *StreamTestWorkflowRunResponse) GetMessage() string {
	if x != nil {
		if x, ok := x.Data.(*StreamTestWorkflowRunResponse_Message); ok {
			return x.Message
		}
	}
	return ""
...
type isStreamTestWorkflowRunResponse_Data interface {
	isStreamTestWorkflowRunResponse_Data()
}

type StreamTestWorkflowRunResponse_Log struct {
	Log *jobs.Log `protobuf:"bytes,2,opt,name=log,proto3,oneof"` // Log data from the test workflow run
}

type StreamTestWorkflowRunResponse_Message struct {
	Message string `protobuf:"bytes,3,opt,name=message,proto3,oneof"` // Message data from the test workflow run
}

func (*StreamTestWorkflowRunResponse_Log) isStreamTestWorkflowRunResponse_Data() {}

func (*StreamTestWorkflowRunResponse_Message) isStreamTestWorkflowRunResponse_Data() {}

var File_workflows_workflows_proto protoreflect.FileDescriptor

const file_workflows_workflows_proto_rawDesc = "" +
	"\n" +
	"\x19workflows/workflows.proto\x12\tworkflows\x1a\x0fjobs/jobs.proto\"\xde\x01\n" +
	...
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\"\x9c\x01\n" +
	"\x1dStreamTestWorkflowRunResponse\x128\n" +
	"\x06status\x18\x01 \x01(\x0e2 .workflows.TestWorkflowRunStatusR\x06status\x12\x1d\n" +
	"\x03log\x18\x02 \x01(\v2\t.jobs.LogH\x00R\x03log\x12\x1a\n" +
	"\amessage\x18\x03 \x01(\tH\x00R\amessageB\x06\n" +
	"\x04data*\x82\x02\n" +
	"\x15TestWorkflowRunStatus\x12(\n" +
	"$TEST_WORKFLOW_RUN_STATUS_UNSPECIFIED\x10\x00\x12%\n" +
	"!TEST_WORKFLOW_RUN_STATUS_BUILDING\x10\x01\x12$\n" +
	" TEST_WORKFLOW_RUN_STATUS_RUNNING\x10\x02\x12&\n" +
	"\"TEST_WORKFLOW_RUN_STATUS_COMPLETED\x10\x03\x12#\n" +
	"\x1fTEST_WORKFLOW_RUN_STATUS_FAILED\x10\x04\x12%\n" +
	"!TEST_WORKFLOW_RUN_STATUS_CANCELED\x10\x052\xc0\t\n" +
	...
	"\rListWorkflows\x12\x1f.workflows.ListWorkflowsRequest\x1a .workflows.ListWorkflowsResponse\"\x00\x12g\n" +
	"\x15StreamTestWorkflowRun\x12 .workflows.CreateWorkflowRequest\x1a(.workflows.StreamTestWorkflowRunResponse\"\x000\x01BFZDgithub.com/hitesh22rana/chronoverse/pkg/proto/go/workflows;workflowsb\x06proto3"
...
var file_workflows_workflows_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_workflows_workflows_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_workflows_workflows_proto_goTypes = []any{
	(TestWorkflowRunStatus)(0),                                   // 0: workflows.TestWorkflowRunStatus
	(*CreateWorkflowRequest)(nil),                                // 1: workflows.CreateWorkflowRequest
	(*CreateWorkflowResponse)(nil),                               // 2: workflows.CreateWorkflowResponse
	(*UpdateWorkflowRequest)(nil),                                // 3: workflows.UpdateWorkflowRequest
	(*UpdateWorkflowResponse)(nil),                               // 4: workflows.UpdateWorkflowResponse
	(*UpdateWorkflowBuildStatusRequest)(nil),                     // 5: workflows.UpdateWorkflowBuildStatusRequest
	(*UpdateWorkflowBuildStatusResponse)(nil),                    // 6: workflows.UpdateWorkflowBuildStatusResponse
	(*GetWorkflowRequest)(nil),                                   // 7: workflows.GetWorkflowRequest
	(*GetWorkflowResponse)(nil),                                  // 8: workflows.GetWorkflowResponse
	(*GetWorkflowByIDRequest)(nil),                               // 9: workflows.GetWorkflowByIDRequest
	(*GetWorkflowByIDResponse)(nil),                              // 10: workflows.GetWorkflowByIDResponse
	(*IncrementWorkflowConsecutiveJobFailuresCountRequest)(nil),  // 11: workflows.IncrementWorkflowConsecutiveJobFailuresCountRequest
	(*IncrementWorkflowConsecutiveJobFailuresCountResponse)(nil), // 12: workflows.IncrementWorkflowConsecutiveJobFailuresCountResponse
	(*ResetWorkflowConsecutiveJobFailuresCountRequest)(nil),      // 13: workflows.ResetWorkflowConsecutiveJobFailuresCountRequest
	(*ResetWorkflowConsecutiveJobFailuresCountResponse)(nil),     // 14: workflows.ResetWorkflowConsecutiveJobFailuresCountResponse
	(*TerminateWorkflowRequest)(nil),                             // 15: workflows.TerminateWorkflowRequest
	(*TerminateWorkflowResponse)(nil),                            // 16: workflows.TerminateWorkflowResponse
	(*DeleteWorkflowRequest)(nil),                                // 17: workflows.DeleteWorkflowRequest
	(*DeleteWorkflowResponse)(nil),                               // 18: workflows.DeleteWorkflowResponse
	(*ListWorkflowsFilters)(nil),                                 // 19: workflows.ListWorkflowsFilters
	(*ListWorkflowsRequest)(nil),                                 // 20: workflows.ListWorkflowsRequest
	(*WorkflowsByUserIDResponse)(nil),                            // 21: workflows.WorkflowsByUserIDResponse
	(*ListWorkflowsResponse)(nil),                                // 22: workflows.ListWorkflowsResponse
	(*StreamTestWorkflowRunResponse)(nil),                        // 23: workflows.StreamTestWorkflowRunResponse
	(*jobs.Log)(nil),                                             // 24: jobs.Log
}
var file_workflows_workflows_proto_depIdxs = []int32{
	19, // 0: workflows.ListWorkflowsRequest.filters:type_name -> workflows.ListWorkflowsFilters
	21, // 1: workflows.ListWorkflowsResponse.workflows:type_name -> workflows.WorkflowsByUserIDResponse
	0,  // 2: workflows.StreamTestWorkflowRunResponse.status:type_name -> workflows.TestWorkflowRunStatus
	24, // 3: workflows.StreamTestWorkflowRunResponse.log:type_name -> jobs.Log
	1,  // 4: workflows.WorkflowsService.CreateWorkflow:input_type -> workflows.CreateWorkflowRequest
	3,  // 5: workflows.WorkflowsService.UpdateWorkflow:input_type -> workflows.UpdateWorkflowRequest
	5,  // 6: workflows.WorkflowsService.UpdateWorkflowBuildStatus:input_type -> workflows.UpdateWorkflowBuildStatusRequest
	7,  // 7: workflows.WorkflowsService.GetWorkflow:input_type -> workflows.GetWorkflowRequest
	9,  // 8: workflows.WorkflowsService.GetWorkflowByID:input_type -> workflows.GetWorkflowByIDRequest
	11, // 9: workflows.WorkflowsService.IncrementWorkflowConsecutiveJobFailuresCount:input_type -> workflows.IncrementWorkflowConsecutiveJobFailuresCountRequest
	13, // 10: workflows.WorkflowsService.ResetWorkflowConsecutiveJobFailuresCount:input_type -> workflows.ResetWorkflowConsecutiveJobFailuresCountRequest
	15, // 11: workflows.WorkflowsService.TerminateWorkflow:input_type -> workflows.TerminateWorkflowRequest
	17, // 12: workflows.WorkflowsService.DeleteWorkflow:input_type -> workflows.DeleteWorkflowRequest
	20, // 13: workflows.WorkflowsService.ListWorkflows:input_type -> workflows.ListWorkflowsRequest
	1,  // 14: workflows.WorkflowsService.StreamTestWorkflowRun:input_type -> workflows.CreateWorkflowRequest
	2,  // 15: workflows.WorkflowsService.CreateWorkflow:output_type -> workflows.CreateWorkflowResponse
	4,  // 16: workflows.WorkflowsService.UpdateWorkflow:output_type -> workflows.UpdateWorkflowResponse
	6,  // 17: workflows.WorkflowsService.UpdateWorkflowBuildStatus:output_type -> workflows.UpdateWorkflowBuildStatusResponse
	8,  // 18: workflows.WorkflowsService.GetWorkflow:output_type -> workflows.GetWorkflowResponse
	10, // 19: workflows.WorkflowsService.GetWorkflowByID:output_type -> workflows.GetWorkflowByIDResponse
	12, // 20: workflows.WorkflowsService.IncrementWorkflowConsecutiveJobFailuresCount:output_type -> workflows.IncrementWorkflowConsecutiveJobFailuresCountResponse
	14, // 21: workflows.WorkflowsService.ResetWorkflowConsecutiveJobFailuresCount:output_type -> workflows.ResetWorkflowConsecutiveJobFailuresCountResponse
	16, // 22: workflows.WorkflowsService.TerminateWorkflow:output_type -> workflows.TerminateWorkflowResponse
	18, // 23: workflows.WorkflowsService.DeleteWorkflow:output_type -> workflows.DeleteWorkflowResponse
	22, // 24: workflows.WorkflowsService.ListWorkflows:output_type -> workflows.ListWorkflowsResponse
	23, // 25: workflows.WorkflowsService.StreamTestWorkflowRun:output_type -> workflows.StreamTestWorkflowRunResponse
...
func file_workflows_workflows_proto_init() {
	...
	file_workflows_workflows_proto_msgTypes[22].OneofWrappers = []any{
		(*StreamTestWorkflowRunResponse_Log)(nil),
		(*StreamTestWorkflowRunResponse_Message)(nil),
	}
	type x struct{}
