...
CREATE TYPE NOTIFICATION_CHANNEL AS ENUM ('EMAIL', 'SMS', 'PUSH', 'WEB');  -- Delivery channel
...
CREATE TABLE IF NOT EXISTS users (
    ...
    notification_channel NOTIFICATION_CHANNEL[] DEFAULT ARRAY['WEB']::NOTIFICATION_CHANNEL[],
