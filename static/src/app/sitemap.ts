...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return routes.map((route) => ({ url: sitePageUrl(route), lastModified: new Date(), changeFrequency: route.startsWith("/docs/api/reference") ? "monthly" : "weekly", priority: route === "" ? 1 : route === "/docs" ? 0.9 : 0.7 }));
}
