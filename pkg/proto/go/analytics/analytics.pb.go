...
type GetWorkflowAnalyticsResponse struct {
	...
	TotalJobs     uint32                 `protobuf:"varint,2,opt,name=total_jobs,json=totalJobs,proto3" json:"total_jobs,omitempty"`          // Total jobs ever created by the workflow
	TotalJoblogs  uint64                 `protobuf:"varint,3,opt,name=total_joblogs,json=totalJoblogs,proto3" json:"total_joblogs,omitempty"` // Total number of job logs generated by the workflow
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_analytics_analytics_proto_rawDesc = "" +
	...
	"workflowId\x12\x1d\n" +
	"\n" +
	"total_jobs\x18\x02 \x01(\rR\ttotalJobs\x12#\n" +
	"\rtotal_joblogs\x18\x03 \x01(\x04R\ftotalJoblogs2\xdc\x01\n" +
