...
type UpdateUserRequest struct {
	...
	NotificationPreference string                 `protobuf:"bytes,2,opt,name=notification_preference,json=notificationPreference,proto3" json:"notification_preference,omitempty"` // User's new notification preference
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
const file_users_users_proto_rawDesc = "" +
	...
	"\x17notification_preference\x18\x02 \x01(\tR\x16notificationPreference\"\x14\n" +
	...
	"\n" +
	"UpdateUser\x12\x18.users.UpdateUserRequest\x1a\x19.users.UpdateUserResponse\"\x00B>Z<github.com/hitesh22rana/chronoverse/pkg/proto/go/users;usersb\x06proto3"
